...
@RestController
@RequestMapping("/api/multi-cloud-manager-kafka")
public class MultiCloudManagerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MultiCloudManagerKafkaResource.class);
    ...
    public MultiCloudManagerKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
